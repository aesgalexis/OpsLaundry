...
const {normalizeMachineSubmission, publicMachine} = require("../lib/laundry/machineSubmissionPolicy");
...
stub("../lib/laundry/spareRequestRateLimit", {enforceSpareRequestRateLimit: async () => {}});
stub("../lib/laundry/spareRequestDelivery", {sendLaundryEmail: async (payload, key) => emails.push({payload, key})});
const {submitLaundryMachine, listLaundryMachineSubmissions, notifyLaundryMachineSubmission, getLaundryMachineSubmissionImage} = require("../lib/laundry/machineSubmissions");
const {reviewLaundryMachineSubmission} = require("../lib/laundry/machineSubmissionReview");
const payload = {

...
const CONFIRMATION_COPY: Record<LaundryLanguage, ConfirmationCopy> = {
  es: {
    ...
    greeting: "Hola",
    firstParagraph: "Gracias por contactar con OpsLaundry. Tu solicitud se ha registrado correctamente.",
  ...
  en: {
    ...
    greeting: "Hello",
    firstParagraph: "Thank you for contacting OpsLaundry. Your request has been registered successfully.",
  ...
  it: {
    ...
    greeting: "Ciao",
    firstParagraph: "Grazie per aver contattato OpsLaundry. La tua richiesta è stata registrata correttamente.",
  ...
  el: {
    ...
    greeting: "Γεια σας",
    firstParagraph: "Σας ευχαριστούμε που επικοινωνήσατε με το OpsLaundry. Το αίτημά σας καταχωρίστηκε επιτυχώς.",
    ...
    buttonLabel: "Μετάβαση στο OpsLaundry",
...
<a href="${LAUNDRY_URL}" style="color:${LAUNDRY_BLUE}">opslaundry.com</a>

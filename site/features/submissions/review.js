...
import {observeMachineAdmin, isAdminUser, loginWithGoogle} from "/shared/auth/admin-access.js";
...
observeMachineAdmin((user) => {
  ...
  document.querySelector("#access-status").textContent = allowed ? "" :
    user ? "Esta cuenta no tiene permiso de administración de OpsLaundry." : "Inicia sesión para revisar las solicitudes.";

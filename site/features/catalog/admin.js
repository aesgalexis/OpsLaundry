...
import {
  ...
  loginWithGoogle,
  resolveAdminUser,
} from "/shared/auth/admin-access.js";
import {
  loadLaundryCatalog,
  publishLaundryCatalog,
} from "/features/catalog/repository.js";
import {
  formatLaundryCatalog,
  parseLaundryCatalog,
  summarizeLaundryCatalog,
} from "/features/catalog/schema.js";
...
const loadCatalog = async () => {
  ...
  try {
    ...
    console.error("OpsLaundry catalogue load failed.", error);
    showValidation({
      valid: false,
...
elements.login.addEventListener("click", async () => {
  ...
  try {
    ...
    console.error("OpsLaundry catalogue login failed.", error);
    showAccess({
...
elements.switchAccount.addEventListener("click", async () => {
  ...
  try {
    ...
    console.error("OpsLaundry catalogue account switch failed.", error);
  } finally {
...
elements.publish.addEventListener("click", async () => {
  ...
  try {
    ...
    console.error("OpsLaundry catalogue publication failed.", error);
